...
- `block_on` (optional): Option to block workflow based on the Upwind Scan Recommendation. Configured value can be either 'DO_NOT_DEPLOY' or 'DEPLOY_WITH_CAUTION'
